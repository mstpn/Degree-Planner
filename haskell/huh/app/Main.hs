...
-- -- TESTING
--   putStrLn "\n\n\nTESTING\n\n"
-- -- Courses per semester 0
--   putStrLn "\n\nCourses per semester 0"
--   testJson <- BSL.readFile "test_json/3.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 0 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"

-- -- Courses per semester -1
--   putStrLn "\n\nCourses per semester -1"
--   testJson <- BSL.readFile "test_json/4.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler (-1) (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"

-- -- "Overconstrained 
-- -- (courses remaining > courses per semester * num semesters)"
--   putStrLn "\n\nOverconstrained"
--   testJson <- BSL.readFile "test_json/5.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 2 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"

-- -- "Overconstrained II
-- -- More reasonable bounds"
--   putStrLn "\n\nOverconstrained II"
--   testJson <- BSL.readFile "test_json/6.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 4 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"

-- -- "Overconstrained III
-- -- Won't fail on math check, but can't schedule"
--   putStrLn "\n\nOverconstrained III"
--   testJson <- BSL.readFile "test_json/7.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 4 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Easy Bounds"
--   putStrLn "\n\nNone Taken Schedule"
--   testJson <- BSL.readFile "test_json/8.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Legal Bounds"
--   putStrLn "\n\nNone Taken Schedule"
--   testJson <- BSL.readFile "test_json/9.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Standard Degree"
--   putStrLn "\n\nNone Taken Schedule"
--   testJson <- BSL.readFile "test_json/10.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- First Year Taken
--   putStrLn "\n\nFirst Year Taken"
--   testJson <- BSL.readFile "test_json/11.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Second Year Taken
--   putStrLn "\n\nSecond Year Taken"
--   testJson <- BSL.readFile "test_json/12.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Third Year Taken
--   putStrLn "\n\nThird Year Taken"
--   testJson <- BSL.readFile "test_json/13.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Junior Options
--   putStrLn "\n\nJunior Options"
--   testJson <- BSL.readFile "test_json/14.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Any degree length"
--   putStrLn "\n\nSenior Options"
--   testJson <- BSL.readFile "test_json/15.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- Any degree length"
--   putStrLn "\n\nSenior Options"
--   testJson <- BSL.readFile "test_json/16.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 20 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- All options
--   putStrLn "\n\nAll options"
--   testJson <- BSL.readFile "test_json/17.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
-- -- All options II
--   putStrLn "\n\nAll options II"
--   testJson <- BSL.readFile "test_json/18.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"


-- -- Invalid Junior options
--   putStrLn "\n\nInvalid Junior options"
--   testJson <- BSL.readFile "test_json/19.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"


-- -- Invalid Senior options
--   putStrLn "\n\nInvalid Senior options"
--   testJson <- BSL.readFile "test_json/20.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"


-- -- Invalid Junior and Senior options
--   putStrLn "\n\nInvalid Junior and Senior options"
--   testJson <- BSL.readFile "test_json/21.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 16 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"
...
--   putStrLn "\n\n1 course per semester"
--   testJson <- BSL.readFile "test_json/22.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 50 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"


-- -- all courses taken
--   putStrLn "\n\nall courses taken"
--   testJson <- BSL.readFile "test_json/23.json"
--   case decode testJson :: Maybe Student of
--     Just student -> printProgram ( degree_handler 50 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student )
--     Nothing -> putStrLn "Failed to parse JSON"