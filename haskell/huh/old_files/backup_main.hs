...
find_shortest_programs numOfSems coursePerSem coursesOfferedFall coursesOfferedWinter student | (is_empty filteredPrograms) = (find_shortest_programs (numOfSems+1) coursePerSem coursesOfferedFall coursesOfferedWinter student)
...
coursesOfferedFall = [ Course "COMP1631" [] [ (Session 0 8 1) ],
                      Course "MATH1200"  [] [Session 0 10 1],
                      Course "COMP2631" ["COMP1633"] [Session 0 12 1],
                      Course "COMP2655" ["COMP1633"] [Session 0 2 1],
                      Course "PHIL1179" [] [Session 0 4 1] ]

coursesOfferedWinter = [ Course "COMP1633" ["COMP1631"] [ Session 0 8 1 ],
                         Course "MATH1203"  [] [Session 0 10 1],
                         Course "COMP2659"  ["PHIL1179","COMP2655"] [Session 0 12 1],
                        Course "COMP2633"  ["COMP2631"] [Session 0 2 1] ]
...
main = do
  ...
  jsonAlice <- BSL.readFile "Alice.json"
  
  case decode jsonAlice :: Maybe Student of
    Just student -> ( printProgramList (take 1 ( (find_shortest_programs 1 (coursesPerSem student) coursesOfferedFall coursesOfferedWinter student) ) )) 
  ...
  -- let student = Student "El Chappo" ["COMP1631"] ["COMP1631","MATH1200","COMP1633","MATH1203","COMP2631","COMP2655","PHIL1179","COMP2659","COMP2633"]
...
--  printStudent student
  ...
  --let shortestPrograms = (find_shortest_programs 1 3 coursesOfferedFall coursesOfferedWinter student)

--  ( printProgramList (find_shortest_programs 1 3 coursesOfferedFall coursesOfferedWinter student) )

  -- let taken = (take 1 shortestPrograms)


-- coursesOfferedFall = [Course "COMP1631"  [] [Session 0 9 1], 
--                     Course "MATH1200"  [] [Session 0 12 1],
--                     Course "COMP2631" ["COMP1633"] [Session 0 9 1],
--                     Course "COMP2655" ["COMP1633"] [Session 0 12 1]]

-- coursesOfferedWinter = [ Course "COMP1633" ["COMP1631"] [Session 0 9 1],
--                         Course "MATH1203"  [] [Session 0 12 1],
--                         Course "PHIL1179" [] [Session 0 2 1],
--                         Course "COMP2659"  ["PHIL1179","COMP2655"] [Session 0 9 1],
--                         Course "COMP2633"  ["COMP2631"] [Session 0 12 1] ]
...
-- coursesOfferedWinter = [ Course "WinterA" ["FallA"] [ Session 0 2 1 ],
--                     Course "WinterB" ["FallB"] [ Session 0 7 1 ],
--                     Course "WinterC" ["FallC"] [ Session 0 3 1 ] ]
